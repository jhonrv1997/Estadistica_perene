            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-scroll">
                        ...
                        <li><a class="dropdown-item <?= $currentpage === 'reporte_cancer' || ($currentpage === 'reporte_operacionales' && $subpage === 'cancer') ? 'active' : '' ?>" href="reporte_cancer.php"><i class="fas fa-ribbon me-2"></i>Cancer <span class="badge bg-success ms-1" style="font-size:.65em">NUEVO</span><small class="d-block text-muted">Reporte Operacional</small></a></li>
                        ...
                        <li><a class="dropdown-item <?= $currentpage === 'reporte_operacionales' && $subpage === 'materno' ? 'active' : '' ?>" href="reporte_materno.php"><i class="fas fa-baby me-2"></i>Materno <span class="badge bg-success ms-1" style="font-size:.65em">NUEVO</span><small class="d-block text-muted">Reporte Operacional</small></a></li>
                        ...
                        <li><a class="dropdown-item <?= $currentpage === 'reporte_no_transmisibles' || ($currentpage === 'reporte_operacionales' && $subpage === 'no_transmisibles') ? 'active' : '' ?>" href="reporte_no_transmisibles.php"><i class="fas fa-heartbeat me-2"></i>No Transmisibles <span class="badge bg-success ms-1" style="font-size:.65em">NUEVO</span><small class="d-block text-muted">Reporte Operacional</small></a></li>
