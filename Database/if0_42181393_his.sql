...
-- Tiempo de generación: 30-07-2026 a las 22:42:15
...
(1, 'admin', '$2a$12$oyHlo6Q4WLAz05diONMFx.D93QR915rs.iVOZx7K1wUpgiTI7CtB.', 'Administrador', 'admin', 1, '2026-06-14 12:35:48', '2026-07-30 19:08:35'),
...
--
ALTER TABLE `ESNI_LINEA_REPORTE`
  MODIFY `id_linea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT de la tabla `ESNI_REGLA`
--
ALTER TABLE `ESNI_REGLA`
  MODIFY `id_regla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=240;
