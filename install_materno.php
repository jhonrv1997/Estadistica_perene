<?php
/**
 * Asistente de instalacion del Modulo MATERNO (paso 1: indices de la tabla).
 *
 * PROBLEMA QUE RESUELVE:
 *   La tabla T_CONSOLIDADO_NUEVA_TRAMA_HISMINSA_DETALLADO puede crearse SIN
 *   indices. El reporte MATERNO consulta esa tabla con (Codigo_Item IN/LIKE
 *   de los codigos del paquete materno) + Anio/Mes/Establecimiento; sin indices
 *   MySQL recorre TODA la tabla en cada clic de "Generar Reporte", lo que en el
 ...
 *
 * NOTA: si ya ejecuto install_cancer.php / install_esni.php, estos indices ya
 * existen y este asistente solo lo verificara (no duplica nada).
 *
 * QUE HACE:
...
$columnaMesInt = maternoTieneColumnaMesInt($pdo);
$indicesDeseados = [
    'idx_cnd_anio'         => "`Anio`",
    'idx_cnd_codigo_item'  => "`Codigo_Item`",
    'idx_cnd_codigo_unico' => "`Codigo_Unico`",
...
$diag = maternoDiagnosticoEntorno($pdo);

$pageTitle = 'Instalacion Modulo MATERNO - Sistema HIS';
        ...
        <div class="col-lg-9">
            <div class="card shadow">
                <div class="card-header bg-his text-white">
                    <h5 class="mb-0"><i class="fas fa-baby me-2"></i>Instalaci&oacute;n del M&oacute;dulo MATERNO &mdash; &Iacute;ndices de la tabla consolidada</h5>
                </div>
                <div class="card-body">
                    <?php if ($resultado['ok']): ?>
                    <div class="alert alert-success">
                        <i class="fas fa-check-circle me-2"></i>
                        <strong>Instalaci&oacute;n completada correctamente.</strong>
                        El bot&oacute;n "Generar Reporte" del m&oacute;dulo MATERNO ahora consulta la tabla con &iacute;ndices.
                    </div>
                    <?php else: ?>
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <strong>La instalaci&oacute;n tuvo problemas.</strong>
                        Revise los errores a continuaci&oacute;n.
                    </div>
                    <?php endif; ?>
                    ...
                    <p class="small text-muted mb-1">Indices que ya exist&iacute;an (no se tocaron): <code><?= htmlspecialchars(implode(', ', $resultado['existentes'])) ?></code></p>
                    <?php endif; ?>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Importante:</strong> por seguridad, elimine este archivo <code>install_materno.php</code> despu&eacute;s de la instalaci&oacute;n.
                    </div>

                    <div class="d-flex gap-2 mt-3">
                        <a href="reporte_materno.php" class="btn btn-his"><i class="fas fa-baby me-1"></i> Ir al Reporte MATERNO</a>
